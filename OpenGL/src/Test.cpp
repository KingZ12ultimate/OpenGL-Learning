...
int main(void)
{
    ...
    Shader shader("resources/shaders/vertex_test.glsl", "resources/shaders/fragment_test.glsl");
	Shader containerShader("resources/shaders/vertex_container.glsl", "resources/shaders/fragment_container.glsl");
	Shader grassShader("resources/shaders/vertex_test.glsl", "resources/shaders/fragment_blend.glsl");
	Shader skyboxShader("resources/shaders/vertex_skybox.glsl", "resources/shaders/fragment_skybox.glsl");
