...
int main(void)
{
	...
	Shader depthShader("resources/shaders/point_shadows_depth.vert", "resources/shaders/point_shadows_depth.frag",
        "resources/shaders/point_shadows_depth.geom");
	Shader shadowShader("resources/shaders/point_shadows.vert", "resources/shaders/point_shadows.frag");
