...
int main(void)
{
    ...
    Shader planetShader("resources/shaders/base.vert", "resources/shaders/base.frag");
    Shader rockShader("resources/shaders/rock_instanced.vert", "resources/shaders/base.frag");
